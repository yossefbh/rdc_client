// src/modules/paiements/components/PaiementList.tsx
...
import { payerEcheance, getEcheanceDetails } from "../services/paiementService";
                      ...
                      {openMenuId === plan.planID && (
                        <div
                          className={`
                            ...
                            ${
                              plans.length > 1 && index >= plans.length - 2
                                ? "top-full mb-3"
                                : "top-full mt-1"
                            }
                          `}
          ...
          <div className="bg-white w-3/4 p-6 rounded-lg shadow-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                ...
                <p className="text-xl font-bold">{selectedPlan.montantRestant} DT</p>
              </div>
            </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full max-h-[80vh] overflow-y-auto">
            ...
            <div className="mb-4 space-y-0.5">
              <p>
                ...
                {selectedEcheanceDetails.montantDeEcheance} DT
              </p>
              <p>
                <strong>Montant payé :</strong> {selectedEcheanceDetails.montantPayee} DT
              </p>
            </div>
                ...
                <tbody>
                  {selectedEcheanceDetails.paiementResponses.map((paiement) => (
                    <tr key={paiement.paiementID} className="border-t hover:bg-gray-50">
                      ...
                      <td className="px-21">{paiement.montantPayee} DT</td>
                    </tr>
                  ))}
                </tbody>
              </table>
